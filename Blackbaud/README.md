# Blackbaud Power BI Connector

This connector uses the SKY API with OAuth 2.0 to connect Power BI to Blackbaud products, including Raiser's Edge NXT and Financial Edge NXT. Many thanks to [Grant Quick](https://github.com/GrantQuick) for the initial creation of this custom connector.

## Watch a demo

Learn how to create your own custom Power BI Connector for Raiser's Edge NXT.
...
3. Open the `Blackbaud.sln` file from the repo root.
